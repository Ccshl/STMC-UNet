...
data_root = '../lanyun-tmp/InriaVOCdevkit/VOC2007'
...
train_cfg = dict(
    max_iters=130000, type='IterBasedTrainLoop', val_interval=10000)
...
work_dir = '../lanyun-tmp/stvit-small-MEMCA-MYF-SKIP-unet-inriaVOC-512x512-100K'
